...
console.log(e.target.buildingTypeId);
    ...
    {/* <Select label="Dropdown" inline>
                                            <Dropdown.Header>
                                                <span className="block text-sm">Select a building type</span>
                                            </Dropdown.Header>
                                            {

                                                buildingTypes.map((buildingType) => {
                                                    <Dropdown.Item key={buildingType.id} value={buildingType.name}>{buildingType.name}</Dropdown.Item>
                                                })
                                            }
    ...
    //         <Modal show={openAddModal} onClose={() => setOpenAddModal(false)} size="xl">
    //             <Modal.Header>
    //                 <div className="text-lg font-semibold text-gray-900 dark:text-white">
    //                     Add Building
    //                 </div>
    ...
    //                                     (buildingTypes.length>0)?(
    //                                     buildingTypes.map((buildingType) => {
    //                                         <Dropdown.Item key={buildingType.id}>{buildingType.name}</Dropdown.Item>
    //                                     })):(
    //                                     <></>)
    //                                 }
